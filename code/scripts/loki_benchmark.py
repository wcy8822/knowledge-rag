...
BENCHMARK_QUERIES = [
    ...
    {
        "query": "变化率 V6 去重取平均",
        "expected_files": ["change_rate_calculator_v6", "change_rate", "变化率"],
    ...
    {
        "query": "发改委搁浅规则 50元每吨",
        "expected_files": ["FGW项目知识图谱", "搁浅", "发改委"],
    ...
    {
        "query": "商户画像宽表字段映射关系",
        "expected_files": ["字段映射", "商户画像宽表", "数据字典"],
        "expected_chunk": "字段映射",
    ...
    },
    {
        ...
        "expected_files": ["ChromaDB", "TECHNICAL_INSIGHTS", "chroma"],
    ...
    },
    {
        ...
        "expected_files": ["loki_pipeline", "loki_reindex", "flock"],
    ...
    },
    {
        ...
        "expected_files": ["FGW项目知识图谱", "原油权重", "change_rate"],
    ...
    },
    {
        ...
        "expected_files": ["server.py", "MCP", "search_knowledge"],
    ...
    },
    {
        ...
        "expected_files": ["loki_reindex", "loki_chunk", "ollama"],
    ...
    },
    {
        ...
        "expected_files": ["l4_gravity_model", "FGW项目知识图谱", "attractiveness"],
    ...
    },
    {
        ...
        "expected_files": ["watchdog", "loki_reindex_watchdog", "loki"],
    ...
    },
    {
        ...
        "expected_files": ["加油站图片识别", "price_hook", "OCR"],
        "expected_chunk": "OCR",
